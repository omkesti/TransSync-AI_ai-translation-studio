      ...
      <aside className="w-[260px] border-r border-[#262626] border-opacity-50 flex flex-col shrink-0 bg-[#0a0a0a] hidden md:flex z-50">
        <div className="p-6 pb-2 flex-1 flex flex-col">
          ...
          <div className="mb-12">
            ...
            <p className="text-[#555555] font-bold text-[9px] uppercase tracking-widest leading-none">
              AI Studio
            </p>
          </div>
        ...
        <header className="h-[88px] w-full border-b border-[#262626] bg-[#0e0e0e] flex items-center justify-between px-8 shrink-0 z-40">
          ...
          <div className="flex flex-col gap-1.5">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[#c5fe00] text-[9px] font-bold uppercase tracking-[0.2em] leading-none">
                Active File
              </span>
            </div>
          ...
          <div className="flex items-center gap-12">
            ...
            <div className="flex flex-col items-end gap-2">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[#8c8c8b] text-[9px] font-bold uppercase tracking-[0.2em] leading-none">
                  Health Score
                </span>
              </div>
        ...
        <div className="flex-1 overflow-y-auto layout-scrollbar pb-[100px]">
          <div className="p-8 lg:p-12 max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 relative">
            ...
            <main className="lg:col-span-8 flex flex-col">
              <div className="mb-12">
                <h1 className="font-display font-black text-[40px] tracking-tight mb-4">
                  source validation
                </h1>
                <p className="text-[#a0a09f] text-[15px] leading-relaxed max-w-2xl font-sans">
                  Our neural analysis engine has detected structural and
                  semantic inconsistencies in the source document. Resolve these
                ...
                <div className="bg-[#151515] border border-[#262626] rounded-[32px] p-8 relative overflow-hidden transition-colors hover:border-[#333333]">
                  ...
                  <div className="flex justify-between items-start mb-6 relative z-10">
                    <div className="flex items-start gap-5">
                      ...
                      <div>
                        <span className="text-[#ff3333] text-[9px] font-bold uppercase tracking-[0.2em] leading-none mb-2 block">
                          High Severity
                        </span>
                        <h3 className="font-display font-bold text-2xl tracking-tight text-white mb-2">
                    ...
                    <div className="text-right">
                      <span className="font-mono text-[#8c8c8b] text-[11px]">
                        Lines: 124, 452,
                        <br />
                        891
                      </span>
                ...
                <div className="bg-[#151515] border border-[#262626] rounded-[32px] p-8 relative overflow-hidden transition-colors hover:border-[#333333]">
                  ...
                  <div className="flex justify-between items-start mb-6 relative z-10">
                    <div className="flex items-start gap-5">
                      ...
                      <div>
                        <span className="text-[#ffd166] text-[9px] font-bold uppercase tracking-[0.2em] leading-none mb-2 block">
                          Medium Severity
                        </span>
                        <h3 className="font-display font-bold text-2xl tracking-tight text-white mb-2">
                          Untranslatable Proper Noun
                        </h3>
                      </div>
                    </div>
                    <div className="text-right">
            ...
            <aside className="lg:col-span-4 flex flex-col gap-12 mt-4 lg:mt-0">
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="bg-[#111111] border border-[#1a1a1a] rounded-[20px] p-5 flex items-center justify-between">
                    <span className="text-[#a0a09f] text-[13px] font-medium">
                      Critical Issues
                    </span>
                    <span className="font-display font-bold text-xl text-[#ff4d4d]">
                  ...
                  <div className="bg-[#111111] border border-[#1a1a1a] rounded-[20px] p-5 flex items-center justify-between">
                    ...
                    <span className="font-display font-bold text-xl text-[#ffd166]">
                      {Math.max(0, validationErrors.length - 1)}
                    </span>
                  </div>
                  <div className="bg-[#111111] border border-[#1a1a1a] rounded-[20px] p-5 flex items-center justify-between">
                    <span className="text-[#a0a09f] text-[13px] font-medium">
              ...
              <div className="bg-[#151515] border border-[#2a2e16] rounded-[24px] p-8 shadow-[0_20px_40px_rgba(197,254,0,0.03)] mt-auto relative overflow-hidden group">
                ...
                <h4 className="font-display text-white font-bold text-[18px] mb-3 relative z-10">
                  AI Quick-Resolve
                </h4>
                <p className="text-[#8c8c8b] text-[12px] leading-relaxed mb-6 font-sans relative z-10">
                  Enable auto-fix for all low-severity issues to speed up the
                  workflow by 25%.
                </p>
                <button className="text-[#c5fe00] hover:text-[#b9ef00] transition-colors font-bold text-[10px] uppercase tracking-widest flex items-center gap-2 relative z-10">
                  {isValidating ? "Validating..." : "Activate Auto-Pilot"}{" "}
                  <ArrowRight size={14} />
                </button>
              </div>
            </aside>
