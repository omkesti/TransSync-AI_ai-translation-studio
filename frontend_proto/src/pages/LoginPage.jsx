        ...
        <div className="bg-[#1a1a1a] p-10 rounded-[32px] w-full max-w-[420px] shadow-[0_40px_80px_rgba(0,0,0,0.6)]">
          ...
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="space-y-2">
              <label className="text-[#8c8c8b] text-xs font-bold uppercase tracking-wider block">Email Address</label>
              <input 
                type="email" 
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                <label className="text-[#8c8c8b] text-xs font-bold uppercase tracking-wider block">Password</label>
                <a href="#" className="text-primary-container text-[10px] font-bold uppercase tracking-widest hover:text-primary transition-colors">Forgot Password?</a>
              </div>
              <input 
                type="password" 
                placeholder="••••••••" 
            ...
            <button 
              type="submit" 
              className="w-full bg-primary-container text-[#0a0a0a] font-bold text-base px-6 py-4 rounded-full mt-8 hover:bg-primary transition-colors shadow-[0_0_30px_rgba(197,254,0,0.2)] flex items-center justify-center gap-2"
            >
          ...
          <div className="mt-8 text-center text-[13px] text-[#8c8c8b] font-medium font-sans">
            New to the platform? <a href="#" className="text-primary-container hover:text-primary transition-colors">Request Access</a>
          </div>
        </div>
